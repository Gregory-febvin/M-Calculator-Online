...
try{
    ...
    $MaBase = new PDO('mysql:host=localhost; dbname=projet-final-bdd; charset=utf8','root', '');
                            ...
                            <form NAME="form3">
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs1.png" alt="LogoArme"  class="img_arme" name="FAUX CHROMÉE III" value="1" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs2.png" alt="LogoArme"  class="img_arme" name="MÂCHOIRE D'OGRE III" value="2" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs3.png" alt="LogoArme"  class="img_arme" name="GRIFFEMORT JAGRAS II" value="3" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs4.png" alt="LogoArme"  class="img_arme" name="FLÉAU DU DIABLE II" value="4" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs5.png" alt="LogoArme"  class="img_arme" name="TRANCHOIR BARROTH II" value="5" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs6.png" alt="LogoArme"  class="img_arme" name="LOHENZAH" value="6" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs7.png" alt="LogoArme"  class="img_arme" name=" ATROCITÉ EXORBITANTE" value="7" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs8.png" alt="LogoArme"  class="img_arme" name="GUILLOTINE NÂGA II" value="8" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs9.png" alt="LogoArme"  class="img_arme" name="HACHOIR RADOBAAN II" value="9" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs10.png" alt="LogoArme"  class="img_arme" name="DON MONSTRO" value="10" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs11.png" alt="LogoArme"  class="img_arme" name=" FLAMBEAU RATHALOS" value="11" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs12.png" alt="LogoArme"  class="img_arme" name="ÉPÉE FOUDRE IMPÉRIALE" value="12" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs13.png" alt="LogoArme"  class="img_arme" name="FENDOIR DE BÛCHER II" value="13" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs14.png" alt="LogoArme"  class="img_arme" name="TOGHRUL-BEG DE DAORA" value="14" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs15.png" alt="LogoArme"  class="img_arme" name="XENO MALIQ +" value="15" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs16.png" alt="LogoArme"  class="img_arme" name="VOLCALAME MAGDAROS" value="16" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs17.png" alt="LogoArme"  class="img_arme" name="ÉPÉE SCEAU-DE-DRAGON II" value="17" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs18.png" alt="LogoArme"  class="img_arme" name="ÉCLAIR TRANCHANT II" value="18" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs19.png" alt="LogoArme"  class="img_arme" name="SINISTRE" value="19" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs20.png" alt="LogoArme"  class="img_arme" name="GOLEM LAGUNA II" value="20" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs21.png" alt="LogoArme"  class="img_arme" name=" MÂCHOIRE WYVERNE ULT" value="21" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs22.png" alt="LogoArme"  class="img_arme" name="ÉPÉE SOUVERAINE" value="22" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs23.png" alt="LogoArme"  class="img_arme" name="LAME EMBRASÉE STYX" value="23" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs24.png" alt="LogoArme"  class="img_arme" name="GRANDE ÉPÉE DU DÉFENSEUR V" value="24" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs25.png" alt="LogoArme"  class="img_arme" name="BOURREAU DE L'ENFER +" value="25" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs26.png" alt="LogoArme"  class="img_arme" name=" MAMMOHACHE II" value="26" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs27.png" alt="LogoArme"  class="img_arme" name="LAME OCCULTE II" value="27" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs28.png" alt="LogoArme"  class="img_arme" name=" LAME GLAVENUS II" value="28" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs29.png" alt="LogoArme"  class="img_arme" name="SÉRAPHIDE AILÉ" value="29" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs30.png" alt="LogoArme"  class="img_arme" name="GRANDE ÉPÉE TIGREX" value="30" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs31.png" alt="LogoArme"  class="img_arme" name="LAME FULGURANTE" value="31" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs32.png" alt="LogoArme"  class="img_arme" name="RASOIR NYX II" value="32" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs33.png" alt="LogoArme"  class="img_arme" name="BRACH-ATTAQUE" value="33" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs34.png" alt="LogoArme"  class="img_arme" name="DHARMA IMMUABLE" value="34" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs35.png" alt="LogoArme"  class="img_arme" name="GRAND GOURDIN DU DÉMON" value="35" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs36.png" alt="LogoArme"  class="img_arme" name="RÉVOLUTION ALATREON" value="36" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs37.png" alt="LogoArme"  class="img_arme" name="BROYEUR ACIDE II" value="37" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs38.png" alt="LogoArme"  class="img_arme" name="MORSURE SAUVAGE" value="38" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs39.png" alt="LogoArme"  class="img_arme" name="GLADIUS XIPHIAS" value="39" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs41.png" alt="LogoArme"  class="img_arme" name="LAME ROYALE VENUS" value="40" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs42.png" alt="LogoArme"  class="img_arme" name="GOURDIN D'OR DU ROI-DÉMON" value="41" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs43.png" alt="LogoArme"  class="img_arme" name=" LAME DE LUMIÈRE" value="42" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs44.png" alt="LogoArme"  class="img_arme" name=" DÉMON DE GLACE" value="43" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs45.png" alt="LogoArme"  class="img_arme" name="LAME NOIRE FATALIS" value="44" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs46.png" alt="LogoArme"  class="img_arme" name="TRANCHEUR SAFI" value="45" onClick="arme(value, name)">
                                ...
                                <div class="thumb_page" name="arme_select">
                                    <div class="fond_monstre_s" >
                                        ...
                                        <input type="image" src="images/gs47.png" alt="LogoArme"  class="img_arme" name="ESPADON KJÁRR" value="46" onClick="arme(value, name)">
                ...
                <div class="selctalent" align="center">
                    ...
                    <div id="modal_talent" class="modal">
	                    <div class="modal-content">
                            ...
                            <span id="close_talent">&times;</span>
                            ...
                            <form NAME="form1">
                                ...
                                <div class="thumb_page" name="talent_select">
                                    <div class="fond_monstre_s">
                                        <input type="image" src="LogoJoyaux" alt="LogoJoyaux"  class="img_talent" name="Machine de guerre" value="2" onClick="talent(value, name)">
                                    </div>
                                ...
                                <div class="thumb_page" name="talent_select">
                                    <div class="fond_monstre_s">
                                        <input type="image" src="LogoJoyaux" alt="LogoJoyaux"  class="img_talent" name="Mise a mort" value="3" onClick="talent(value, name)">
                                    </div>
                                    <h5>Mise a mort</h5>
                                </div>
                                <div class="thumb_page" name="talent_select">
                    ...
                    <div id="modal" class="modal">
	                    <div class="modal-content">
                            ...
                            <form name="form2">
                                ...
                                <div class="thumb_page" name="talent_select">
                                    <div class="fond_monstre_s">
                                        <input type="image" src="images/Anjanath" alt="Anjanath"  class="img_monstre" name="Anjanath" value="3" onClick="monstre(value, name)">
                                    </div>
                                    <h5>Anjanath</h5>
                                </div>
                                <div class="thumb_page" name="talent_select">
                                    <div class="fond_monstre_s">
                                        <input type="image" src="images/Banbaro" alt="Banbaro"  class="img_monstre" name="Banbaro" value="4" onClick="monstre(value, name)">
                                    </div>
                                    <h5>Banbaro</h5>
                                </div>
                                <div class="thumb_page" name="talent_select">
                                ...
                                <div class="thumb_page" name="talent_select">
                                    <div class="fond_monstre_s" >
                                        <img src="images/Fatalis.png" alt="Fatalis"  class="img_monstre" value="19" name="Fatalis" onClick="monstre(value, name)">
                                    </div>
                                    <h5>Fatalis</h5>
                                </div>
                                <div class="thumb_page" name="talent_select">
...
if(isset($_POST["Talent"])) {
    ...
    $basetalent = $MaBase->query("SELECT * FROM `Talent` WHERE idTalent = (".$talents.")");
